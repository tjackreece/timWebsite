...
export const LettersRecommendation = [
  {
    id: "mikeHiner",
    position: "Cheif Technology Officer",
    company: "Amida Technology Solutions",
    title: "Mike Hiner - Letter of Recommendation",
    name: "Mike Hiner",
    file: MIKE,
    thumbnail: MIKE_Thumbnail,
  },
  {
    id: "ericWest",
    position: "Technical Lead Developer",
    company: "Amida Technology Solutions",
    title: "Eric West - Letter of Recommendation",
    name: "Eric West",
    file: ERIC,
    thumbnail: ERIC_Thumbnail,
  },
];
